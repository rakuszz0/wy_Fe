...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <Container fluid className="margin-top-content d-flex warp justify-content-start gap-3" style={{ marginTop: "7rem" }}>
                {filteredData?.map((value) => {
                    return (
                        <div key={value.id} className="d-flex flex-column p-2 rounded" style={{ width: "360px", backgroundColor: "#0b0b0b" }}>
